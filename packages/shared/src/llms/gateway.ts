...
export type AgentMessagePart =
	...
	| { type: "reasoning"; text: string; metadata?: Record<string, unknown> }
	| { type: "image"; image: string | Uint8Array | ArrayBuffer | URL; mediaType?: string }
	| { type: "file"; path: string; content: string }
	| { type: "tool-call"; toolCallId: string; toolName: string; input?: unknown; metadata?: Record<string, unknown> }
...
export type AgentModelFinishReason = "stop" | "tool-calls" | "max-tokens" | "error"
...
export type AgentModelEvent =
	...
	| { type: "reasoning-delta"; text: string; metadata?: Record<string, unknown> }
	| {
...
export type GatewayProviderFamily = "openai" | "openai-compatible" | "anthropic" | "google" | "vertex" | "bedrock" | "mistral" | "local" | "vscode"
export type GatewayPromptCacheStrategy = "anthropic-automatic"

export interface GatewayProviderMetadata {
	family?: GatewayProviderFamily
...
export interface GatewayStreamRequest {
	...
	maxTokens?: number
	metadata?: Record<string, unknown>
	reasoning?: { enabled?: boolean; effort?: "low" | "medium" | "high" | "xhigh"; budgetTokens?: number }
	signal?: AbortSignal
}
...
export interface ProviderGovernancePolicy {
	...
	defaultModelId?: string
	roleDefaults?: Record<string, { providerId: string; modelId: string }>
	projectDefaults?: Record<string, { providerId: string; modelId: string }>
}